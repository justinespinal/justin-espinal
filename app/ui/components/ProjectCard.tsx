...
export default function ProjectCard({
    ...
    return (
        <div>
            <div onClick={navigate} className="transition-colors bg-[rgb(24,24,27)] border-gray-700 hover:border-slate-300 border rounded-md hover:cursor-pointer h-auto p-3 flex flex-col gap-4 lg:h-[15em] lg:w-[30em]">
