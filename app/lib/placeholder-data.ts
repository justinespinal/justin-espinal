const companies = [
  ...
  },
  {
    ...
    image_url: '/bloomberg.jpg',
    info: "Joined Bloomberg Law on the Integrations and Workflows Team, where I developed in Artificial Intelligence tool to improve litigation workflows. Implemented sophisticated Retrieval-Augmented (RAG) methodologies to minimize hallucinations and deliver accurate results"
  },
  {
